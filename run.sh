...
cp helloA1/target/helloA1.jar mods/org/jbugkorea/helloA1/main/
...
#SCRIPT=${BYTEMAN_HOME}/sample/scripts/ClassLoader.btm
SCRIPT=byteman/ConcurrentClassLoader.btm
${BYTEMAN_HOME}/bin/bmjava.sh -l $SCRIPT -jar jboss-modules-1.5.2.Final.jar -mp mods org.jbugkorea.app
#${BYTEMAN_HOME}/bin/bmjava.sh -l $SCRIPT -jar jboss-modules-1.5.2.Final.jar -deptree -mp mods org.jbugkorea.app
